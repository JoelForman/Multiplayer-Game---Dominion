...
//			System.out.println("SERVER > " + message);
	...
	private void parsePacket(byte[] data, InetAddress address, int port) {
		...
		case DISCONNECT:
			...
			game.handler.removePlayerMP(((Packet01Disconnect) packet).getUsername());
			break;
		case MOVE:
	...
	private void handleLogin(Packet00Login packet, InetAddress address, int port){
		...
		PlayerMP player = new PlayerMP(packet.getX(), packet.getY(), 0, packet.getUsername(), ObjectId.Player, address, port);
